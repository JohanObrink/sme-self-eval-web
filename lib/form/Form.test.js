...
jest.mock('react-router-dom', () => ({
  ...
  useLocation: jest.fn().mockReturnValue({ path: '/test' }),
}))
...
describe('form/Form', () => {
  ...
  describe('navigation', () => {
    beforeEach(() => {
      props.form.steps = [{ title: 'Step 1' }, { title: 'Step 2' }, { title: 'Step 3' }]
    })
    ...
    it('shows both on second step', async () => {
      ...
      await waitFor(() => {
        ...
        expect(getAllByRole('button')[0]).toHaveTextContent('Tillbaka')
