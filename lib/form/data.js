      ...
      questions: [
        {
          path: 'invoices',
          question:
            'Har du ansökt om att få betala fakturor till dina leverantörer längre fram?',
          suggestion:
            'Ansök om att få betala fakturor till dina leverantörer längre fram',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          path: 'dormant',
          question:
            'Har du undersökt möjligheten att lägga företaget som vilande?',
        ...
        },
        {
          ...
          suggestion:
            'Gå igenom andra kostnadsbesparingar du skulle kunna göra på kort sikt',
          type: questionTypes.YES_NO,
          validate: validations.required,
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          path: 'pausePension',
          question:
            'Har du pausat inbetalningarna till dina anställdas tjänstepensionsplan?',
          suggestion:
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          path: 'postponeTax',
          question:
            'Har du ansökt om att skjuta upp företagets skatteinbetalningar?',
